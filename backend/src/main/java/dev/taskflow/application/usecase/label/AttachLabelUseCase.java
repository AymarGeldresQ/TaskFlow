...
@Service
public class AttachLabelUseCase {
    ...
    public AttachLabelUseCase(LabelRepository labelRepository,
    ...
    public void execute(UUID taskId, UUID labelId, UUID actorId) {
        ...
        membershipRepository.findByTeamIdAndUserId(project.getTeamId(), actorId)
            ...
            .orElseThrow(() -> new dev.taskflow.domain.exception.UnauthorizedOperationException("attach label"));
